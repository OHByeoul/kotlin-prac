...
class UserServiceTest @Autowired constructor (
    ...
    @Test
    @DisplayName("대출 기록 없는 유저도 응답에 포함")
    fun getUserLoanHistoryiesTest1() {
        //given
        userRepository.save(User("A", null))
        //when
    ...
    @Test
    @DisplayName("대출 기록이 여러개인 유저의 응답이 정상 동작")
    fun getUserLoanHistoryiesTest2() {
        //given
        val savedUser = userRepository.save(User("A", null))
    ...
    @Test
    @DisplayName("대출 기록이 여러개인 유저와 아닌 유저 동시 테스트")
    fun getUserLoanHistoryiesTest3() {
        //given

        val saveUsers = userRepository.saveAll(
            listOf(
                User("A", null),
                User("B", null),
            )
